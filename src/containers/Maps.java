...
import java.util.concurrent.*;import com.sun.tools.javac.comp.Enter;
...
//    test(new WeakHashMap<Integer,String>());
	  ...
	  countryDetailList.put("1111", new Integer[]{1,2,3});
	  
	  for (Entry<String, Integer[]>  countryDetail : countryDetailList.entrySet()) {
		System.out.println("key  " + countryDetail.getKey() + "glod" + countryDetail.getValue()[0]);
	}
	  
	  
	  String string = "China 32 28 34";
